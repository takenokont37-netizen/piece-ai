...
/* SNSリンク（アカウント開設後に href の # を実際のURLに変更してください） */
const socialLinks = [
  {
    label: 'X (Twitter)',
    href: '#',
          ...
          <div className="flex gap-2.5 mt-4">
            {socialLinks.map(({ label, href, svg }) => (
              <a
                ...
                className="flex items-center justify-center w-9 h-9 rounded-full bg-white/8 border border-white/12 text-white/65 transition-all hover:bg-[#5b6ef5] hover:border-[#5b6ef5] hover:text-white hover:-translate-y-0.5"
              >
